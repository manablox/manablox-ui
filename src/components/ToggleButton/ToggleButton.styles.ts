...
.mb-togglebutton-content{display:inline-flex;align-items:center;justify-content:center}
...
::slotted([slot="icon"]){margin-right:0.5rem;display:inline-flex;align-items:center}
`;
export {};
